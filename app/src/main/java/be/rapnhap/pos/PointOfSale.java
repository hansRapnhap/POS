...
public class PointOfSale extends AppCompatActivity  {
    ...
    public void initializeQty() {
        ...
        priceI2 = BigDecimal.valueOf(2.20); // i Cornet
        priceI3 = BigDecimal.valueOf(1.50); // i maxi vanille
        priceI4 = BigDecimal.valueOf(1.20); // i Satelite
        ...
        priceF1 = BigDecimal.valueOf(1.70); // f Cola
        priceF2 = BigDecimal.valueOf(1.70); // f Cola Zero
        priceF3 = BigDecimal.valueOf(1.70); // f Ice Tea
        priceF4 = BigDecimal.valueOf(1.70); // f Fanta
